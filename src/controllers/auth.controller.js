...
export const updatePassword = async (req, res) => {
    ...
    try {
        ...
        const isMatch = await bcrypt.compare(antiguoPassword, userFound.password); // compara el usuario pasword puesto en el form con el usuario password de la bd
        ...
        userFound.nombres = nombres;
        userFound.apellidos = apellidos;
        userFound.cedula = cedula;
        userFound.celular = celular;
        userFound.fecha = fecha;
