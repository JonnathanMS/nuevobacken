...
router.get('/citasGeneralT/:code', authRequired, getCitasGeneralTutor); //!obtener varios elementos filtrados  ////EN ESTE CASO HAY QUE PONER EN LA URL ASI : http://localhost:4000/api/citasGeneral/6511f8abc67ece9144c2ea4b
